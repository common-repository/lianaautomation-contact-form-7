...
LianaAutomation for Contact Form 7 is an integration plugin for the LianaAutomation marketing automation platform. It enables the creation of automations and segmenting customer data in the marketing automation solution LianaAutomation, based on form data collected from Contact Form 7.

= Create Automations for your WordPress site visitors =

LianaAutomation allows you to collect data from your WordPress site, create segments based on the data, and create marketing automations based on those segments.
...
1. Formsend event results in Automation
2. Plugin configuration admin panel
...
Yes, LianaAutomation will work with any theme.
